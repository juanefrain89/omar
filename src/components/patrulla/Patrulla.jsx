    ...
    <>
      ...
      {ver == true?( <div className="absolu">
        ...
        <div className="contenedoropciones">
          ...
          <div className="carac"><h1>placa : ubx728 </h1><h1>direccion: monterrey</h1> <p> {pm} el id</p>   <h1>unidad : 5656 </h1> <button className='modificar'>modificar</button> </div>
          </div></div>
          </div>):( <Inicio />)}
